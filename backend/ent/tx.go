...
func (tx *Tx) init() {
	...
	tx.ProblemStatus = NewProblemStatusClient(tx.config)
	tx.ProblemTitle = NewProblemTitleClient(tx.config)
...
// applies a query, for example: Problem.QueryXXX(), the query will be executed
