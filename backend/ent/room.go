...
func (e RoomEdges) UserOrErr() (*User, error) {
	if e.loadedTypes[0] {
		if e.User == nil {
...
// Room2problemOrErr returns the Room2problem value or an error if the edge
// was not loaded in eager-loading.
func (e RoomEdges) Room2problemOrErr() ([]*Problem, error) {
	if e.loadedTypes[1] {
		return e.Room2problem, nil
	}
	return nil, &NotLoadedError{edge: "room2problem"}
}
...
// QueryUser queries the user edge of the Room.
func (r *Room) QueryUser() *UserQuery {
	return (&RoomClient{config: r.config}).QueryUser(r)
}

// QueryRoom2problem queries the room2problem edge of the Room.
func (r *Room) QueryRoom2problem() *ProblemQuery {
	return (&RoomClient{config: r.config}).QueryRoom2problem(r)
}
